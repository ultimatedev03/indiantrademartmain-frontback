  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        // Supports explicit roles and generic 'EMPLOYEE' fallback if specific role dashboard exists
        ...
        switch(user.role) {
          ...
          case 'HR':
            ...
            break;
          case 'DATA_ENTRY':
          case 'DATAENTRY': // Handle potential legacy naming
          ...
          case 'SALES':
            ...
            break;
          case 'EMPLOYEE': 
            // Generic fallback if user role is just 'EMPLOYEE'
            // We'll send them to data entry or a general dashboard if available
            navigate('/employee/dataentry/dashboard');
            break;
          default:
             // If valid user but role unknown, log and error
