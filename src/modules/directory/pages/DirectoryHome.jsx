  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <div className="container mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold text-slate-900 mb-8">Browse Industries</h2>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {categories.map((cat, i) => (
              ...
              >
                <Link to={`/directory/${cat.slug}`} className="block bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg hover:border-blue-500 transition-all group h-full">
                  ...
                  <p className="text-sm text-slate-500 mt-2 line-clamp-2">{cat.description || 'Explore products and suppliers in this category.'}</p>
                </Link>
              </motion.div>
            ))}
          </div>
