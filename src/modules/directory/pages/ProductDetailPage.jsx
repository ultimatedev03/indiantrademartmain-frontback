...
const ProductDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
       ...
       <div className="bg-white border-b py-3 px-4 mb-6 shadow-sm">
           ...
           <div className="lg:col-span-1">
               <div className="bg-white rounded-xl shadow-lg border border-blue-100 p-6 sticky top-24">
                   <div className="flex items-start gap-4 mb-4">
                       ...
                       <div>
                           <h3 className="font-bold text-lg text-slate-900 leading-tight">{vendor.company_name}</h3>
                   ...
                   <Button className="w-full bg-[#003D82] h-12 text-lg mb-3 hover:bg-blue-800">Send Enquiry</Button>
                   <Button 
                     variant="outline" 
                     className="w-full"
