            ...
            <div className="space-y-8">
              ...
              {hasMoreHeads && (
                <div className="flex justify-center pt-2">
                  ...
                  >
                    {showAllHeads ? 'View less' : `View more (${homeCategories.length - HEAD_INITIAL_LIMIT})`}
                  </button>
                </div>
              )}
            </div>
