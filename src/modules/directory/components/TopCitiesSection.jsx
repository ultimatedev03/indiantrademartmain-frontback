...
const TopCitiesSection = () => {
  ...
  useEffect(() => {
    const loadCities = async () => {
      // Fetch more than 10 so we can force our UI order reliably
      const data = await directoryApi.getTopCities(200);
    ...
    if (name.includes('delhi'))
      return (
        <img
          ...
          src="https://images.unsplash.com/photo-1703083664356-a15a04d42e4c"
        />
      );
    ...
    if (name.includes('mumbai'))
      return (
        <img
          ...
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1518918249916-0a72d4f98658"
        />
      );
    ...
    if (name.includes('bengaluru') || name.includes('bangalore') || name.includes('bangaluru'))
      return (
        <img
          ...
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1698127091046-3e260f65d6d8"
        />
      );
    ...
    if (name.includes('chennai'))
      return (
        <img
          ...
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1635472276754-a5369ebf1bba"
        />
      );
    ...
    if (name.includes('kolkata'))
      return (
        <img
          ...
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1571481808344-77708908c5a9"
        />
      );
    ...
    if (name.includes('jaipur'))
      return (
        <img
          alt="Hawa Mahal Icon"
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1617516203158-1b87bb39caa7"
        />
      );
    ...
    if (name.includes('ahmedabad'))
      return (
        <img
          alt="Ahmedabad Icon"
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1674783358278-bed2d6a4d57d"
        />
      );
    ...
    if (name.includes('hyderabad'))
      return (
        <img
          alt="Charminar Icon"
          className="w-full h-full object-contain p-2"
          src="https://images.unsplash.com/photo-1610341940372-5aab4d3786cb"
        />
      );
