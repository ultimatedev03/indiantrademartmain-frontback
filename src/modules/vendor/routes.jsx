...
import VendorSupportTicket from '@/modules/vendor/pages/SupportTicketDetail';
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRoles={['VENDOR']} redirectTo="/vendor/login" />}>
        <Route element={<PageStatusWrapper pageRoute="/vendor"><VendorPortalLayout /></PageStatusWrapper>}>
